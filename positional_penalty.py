...
optparser.add_option("-i", "--pos_diff_penalty", dest="pos_penalty", default=.00000001, type="float", help="Position difference penalty")
...
for eindex, e in enumerate(e_sents):
    ...
    for sindex, s in enumerate(s_sents[start:end]):
        ...
        score -= opts.pos_penalty * pos_dif
